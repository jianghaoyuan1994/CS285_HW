...
class FFModel(BaseModel):
    ...
    def define_forward_pass(self):
        ...
        self.delta_pred_unnormalized = unnormalize(self.delta_pred_unnormalized, self.delta_mean_pl, self.delta_std_pl)# TODO(Q1) Unnormalize the the delta_pred above using the unnormalize function, and self.delta_mean_pl and self.delta_std_pl
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        _, loss = self.sess.run([self.train_op, self.loss], feed_dict={
            self.obs_pl: observations, self.acs_pl: actions,
            self.delta_labels: next_observations - data_statistics,
